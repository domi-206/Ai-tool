...
const Header: React.FC<HeaderProps> = ({ activeView, onViewChange }) => {
  return (
    <header className="flex justify-center items-center py-6">
      <div className="bg-white rounded-lg shadow-sm p-1 flex space-x-1 border border-gray-200 overflow-x-auto max-w-full">
        {/* Button 1: Smart Summary */}
        <button 
